...
export default function RegisterForm(){
    return(
        <View className="bg-[#F2EAD3] mt-10 w-11/12 py-3 px-3 rounded-2xl mx-auto grid grid-flow-row shadow">
            ...
            <TextInput className="px-2 border border-custom-secondary rounded-lg text-black text-lg h-12 bg-custom-background"/>
            ...
            <Pressable onPress={()=>{router.replace('/(screens)/MyEvents')}} className="w-full h-16 bg-custom-secondary mt-10 rounded-lg">
